...
@click.argument(
    "imported", type=click.Path(resolve_path=True, readable=True), nargs=-1, required=True
)
@click.pass_context
def from_binary(ctx: click.Context, imported, **kwargs: Any) -> None:
...
@click.pass_context
def from_text(ctx: click.Context, imported, **kwargs: Any) -> None:
